...
Feature: Warehouses - Locations - State Supply Chain Manager
As a valid BSuite User with role "State Supply Chain Manager",
I am able to browse for locations and details about Warehouses.

@GSQA-98    
Scenario Outline: Warehouses - Locations - State Supply Chain Manager
