...
namespace BSuiteE2ERegressionTestSuite.Features.Warehouses
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Warehouses - Locations - State Supply Chain Manager", new string[] {
            "AllTests",
            "BSuite",
            "BSuite-Website",
            "Logistics-Admin",
            "Warehouses"}, Description="As a valid BSuite User with role \"State Supply Chain Manager\",\r\nI am able to brow" +
        "se for locations and details about Warehouses.", SourceFile="Features\\Warehouses\\Warehouses - Locations - State Supply Chain Manager.feature", SourceLine=1)]
    public partial class Warehouses_Locations_StateSupplyChainManagerFeature
    {
...
#line 1 "Warehouses - Locations - State Supply Chain Manager.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/Warehouses", "Warehouses - Locations - State Supply Chain Manager", "As a valid BSuite User with role \"State Supply Chain Manager\",\r\nI am able to brow" +
                    "se for locations and details about Warehouses.", ProgrammingLanguage.CSharp, new string[] {
                        "AllTests",
                        "BSuite",
                        "BSuite-Website",
                        "Logistics-Admin",
        ...
        public virtual void Warehouses_Locations_StateSupplyChainManager(string role, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Warehouses - Locations - State Supply Chain Manager", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 7
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("Warehouses - Locations - State Supply Chain Manager, State Supply Chain Manager", new string[] {
                "GSQA-98"}, SourceLine=49)]
        public virtual void Warehouses_Locations_StateSupplyChainManager_StateSupplyChainManager()
        {
#line 7
this.Warehouses_Locations_StateSupplyChainManager("State Supply Chain Manager", ((string[])(null)));
#line hidden
        }
    }
}
