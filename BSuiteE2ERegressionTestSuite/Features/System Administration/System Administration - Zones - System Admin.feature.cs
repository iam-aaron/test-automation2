...
namespace BSuiteE2ERegressionTestSuite.Features.SystemAdministration
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("System Administration - Zones - System Admin", new string[] {
            "AllTests",
            "BSuite",
            "BSuite-Website",
            "System-Admin",
            "System-Administration"}, Description="\tAs a User with role System Admin accessing BSuite desktop portal,I am able to vi" +
        "ew/add a Zone under a Zone Set", SourceFile="Features\\System Administration\\System Administration - Zones - System Admin.featu" +
        "re", SourceLine=1)]
    public partial class SystemAdministration_Zones_SystemAdminFeature
    {
...
#line 1 "System Administration - Zones - System Admin.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features/System Administration", "System Administration - Zones - System Admin", "\tAs a User with role System Admin accessing BSuite desktop portal,I am able to vi" +
                    "ew/add a Zone under a Zone Set", ProgrammingLanguage.CSharp, new string[] {
                        "AllTests",
                        "BSuite",
                        "BSuite-Website",
                        "System-Admin",
        ...
        public virtual void SystemAdministration_Zones_SystemAdmin(string role, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("System Administration - Zones - System Admin", null, tagsOfScenario, argumentsOfScenario, this._featureTags);
#line 6
...
#line hidden
        ...
        [TechTalk.SpecRun.ScenarioAttribute("System Administration - Zones - System Admin, System Admin", new string[] {
                "GSQA-117",
                "PositiveTests"}, SourceLine=21)]
        public virtual void SystemAdministration_Zones_SystemAdmin_SystemAdmin()
        {
#line 6
this.SystemAdministration_Zones_SystemAdmin("System Admin", ((string[])(null)));
#line hidden
        }
    }
}
