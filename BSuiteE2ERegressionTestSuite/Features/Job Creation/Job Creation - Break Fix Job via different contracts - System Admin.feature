@AllTests @BSuite @BSuiteDesktop @JobLogging @SystemAdmin
Feature: Job Creation - Break Fix Job via different contracts - System Admin
As a BSuite desktop User with role System Admin at Call Center
...
Scenario Outline: Job Creation - Break Fix Job via different contracts - System Admin
	...
	When I enter the following details in the 'Add Task - FieldTask' page
		...
		| Problem Desc      | GSQA3 Regression Test |
		| Client Notes      | GSQA3 Regression Test |
		| Call Centre Notes | GSQA3 Regression Test |  
