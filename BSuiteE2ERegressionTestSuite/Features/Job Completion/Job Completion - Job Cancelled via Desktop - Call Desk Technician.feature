@AllTests @Bsuite @BSuite-Website @Job-Completion @Call-Desk-Technician
Feature: Job Completion - Job Cancelled via Desktop - Call Desk Technician
As a User with role "Call Desk Technician" accessing BSuite desktop portal,
I am able to Cancel a Task

Description
@GSQA-54
Scenario: Job Completion - Job Cancelled via Desktop - Call Desk Technician
	Given I have logged into BSuite 'Desktop' portal as a User with role 'Call Desk Technician'
