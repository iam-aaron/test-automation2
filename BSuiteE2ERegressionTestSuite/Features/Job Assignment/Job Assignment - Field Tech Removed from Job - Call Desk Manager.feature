@AllTests @Bsuite @BSuite-Website @Call-Desk-Manager @Job-Assignment 
Feature: Job Assignment - Field Tech Removed from Job - Call Desk Manager
...
@GSQA-27
Scenario: Job Assignment - Field Tech Removed from Job - Call Desk Manager
