...
Scenario Outline: Health and Safety - Daily PreStart Form - Logistics-Admin "No" Scenario
Responds to questions where the Logistics-Admin answers no and enters that he has contacted the People leader.
Once the Checklist is reactivated by the People Leader then Logistics-Admin can then proceed to the next question. 
