@AllTests @BSuite @BSuite-Website @Monitoring @Logistics-Admin
Feature: Monitoring - Task Lists - Logistics Admin
As a User with role Logistics Admin accessing BSuite desktop portal,
I am able to monitor tasks and agent/technician activities.

@GSQA-69 
Scenario: Monitoring - Task Lists - Logistics Admin
	...
	And I add the technician 'TestAgentTechnician100' from 'All Agents' to 'Agents currently on watch list' in 'Edit Watch List Preference' page
	And I add the technician 'TestAgentTechnician101' from 'All Agents' to 'Agents currently on watch list' in 'Edit Watch List Preference' page
	And I add the technician 'TestFieldTechnician100' from 'All Technicians' to 'Technicians currently on watch list' in 'Edit Watch List Preference' page
	And I add the technician 'TestFieldTechnician101' from 'All Technicians' to 'Technicians currently on watch list' in 'Edit Watch List Preference' page
	...
	And I verify the 'Tasks by Watch List' page has the following buttons
			 ...
			 | Edit Preferences |
			 | Show Legend      |	
	And I verify 'TestFieldTechnician100' is displayed under 'Technicians' on 'Assigned to Techs' tab
	And I verify 'TestFieldTechnician101' is displayed under 'Technicians' on 'Assigned to Techs' tab
	...
	And I verify 'TestAgentTechnician100' is displayed under 'Agents/Clients' on 'Assigned to Agents' tab
	And I verify 'TestAgentTechnician101' is displayed under 'Agents/Clients' on 'Assigned to Agents' tab
